...
<input type="hidden" name="tea_add_contents[<?php echo $number ?>][type]" value="multiselect" />
...
<div class="label-edit-options model-multiple" style="display:block;">
    ...
    <div class="label-model">
        <label class="label-option">
            <input type="checkbox" name="tea_add_contents[<?php echo $number ?>][default][__OPTNUM__]" value="1" />
        </label>
        <label class="label-first">
    ...
    ?>
        ...
        ?>
            <label class="label-option">
                <input type="checkbox" name="tea_add_contents[<?php echo $number ?>][std][<?php echo $valvalue ?>]" value="<?php echo $valvalue ?>" <?php echo isset($std[$valvalue]) ? 'checked="checked"' : '' ?> />
            </label>
            <label class="label-first">
